...
export default {
  ...
  data() {
    return {
      ...
      searchForm: [
        { label: '还愿内容', type: 'input', formName: 'content' },
        {
          label: '创建时间',
      ...
      column: [
        { type: 'index', label: '序号', align: 'center' },
        {
          ...
          align: 'center',
          formatter: row => {
            return row.userImgUrl? <el-image src={row.userImgUrl} style="width:50px;height:50px"></el-image>:
            <div style="width:120px;text-align:center">-</div>
          }
        },
        { prop: 'userName', label: '昵称', align: 'center' },
        { prop: 'userMobile', label: '电话', align: 'center' },
        { prop: 'content', label: '还愿内容', align: 'center',width: '400px'},
        // {
        //   label: '是否显示',
        //   align: 'center',
        //   formatter: row => {
